...
class Game(models.Model):
	...
	player_one = models.ForeignKey(User, on_delete=models.PROTECT, related_name='player_one')
	player_two = models.ForeignKey(User, on_delete=models.PROTECT, related_name='player_two')
